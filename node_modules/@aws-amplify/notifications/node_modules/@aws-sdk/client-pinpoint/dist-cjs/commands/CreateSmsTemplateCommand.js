...
class CreateSmsTemplateCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.CreateSmsTemplateRequestFilterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.CreateSmsTemplateResponseFilterSensitiveLog,
        };
