...
class GetApnsChannelCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.GetApnsChannelRequestFilterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.GetApnsChannelResponseFilterSensitiveLog,
        };
