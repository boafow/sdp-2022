...
class GetJourneyDateRangeKpiCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_1_1.GetJourneyDateRangeKpiRequestFilterSensitiveLog,
            outputFilterSensitiveLog: models_1_1.GetJourneyDateRangeKpiResponseFilterSensitiveLog,
        };
