...
class UpdateGcmChannelCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_1_1.UpdateGcmChannelRequestFilterSensitiveLog,
            outputFilterSensitiveLog: models_1_1.UpdateGcmChannelResponseFilterSensitiveLog,
        };
