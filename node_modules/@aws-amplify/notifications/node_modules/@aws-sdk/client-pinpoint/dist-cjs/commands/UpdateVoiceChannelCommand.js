...
class UpdateVoiceChannelCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_1_1.UpdateVoiceChannelRequestFilterSensitiveLog,
            outputFilterSensitiveLog: models_1_1.UpdateVoiceChannelResponseFilterSensitiveLog,
        };
