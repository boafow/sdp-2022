...
var Storage = /** @class */ (function () {
    ...
    Storage.prototype.copy = function (src, dest, config) {
        ...
        var responsePromise = prov.copy(src, dest, tslib_1.__assign(tslib_1.__assign({}, config), { cancelTokenSource: cancelTokenSource }));
    ...
    Storage.prototype.get = function (key, config) {
        ...
        var cancelTokenSource = this.getCancellableTokenSource();
        var responsePromise = prov.get(key, tslib_1.__assign(tslib_1.__assign({}, config), { cancelTokenSource: cancelTokenSource }));
        this.updateRequestToBeCancellable(responsePromise, cancelTokenSource);
        return responsePromise;
    };
    ...
    Storage.prototype.put = function (key, object, config) {
        ...
        var cancelTokenSource = this.getCancellableTokenSource();
        var response = prov.put(key, object, tslib_1.__assign(tslib_1.__assign({}, config), { cancelTokenSource: cancelTokenSource }));
