...
async function findIdentitiesAsync() {
  ...
  const results = (_await$spawnAsync$std3 = (_await$spawnAsync$std4 = (await (0, _spawnAsync().default)('security', ['find-identity', '-p', 'codesigning', '-v'])).stdout).trim) === null || _await$spawnAsync$std3 === void 0 ? void 0 : _await$spawnAsync$std3.call(_await$spawnAsync$std4);
