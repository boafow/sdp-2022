...
function formatWebpackMessages(json) {
  ...
  const formattedErrors = json === null || json === void 0 ? void 0 : (_json$errors = json.errors) === null || _json$errors === void 0 ? void 0 : _json$errors.map(formatMessage);
  const formattedWarnings = json === null || json === void 0 ? void 0 : (_json$warnings = json.warnings) === null || _json$warnings === void 0 ? void 0 : _json$warnings.map(formatMessage);
  const result = {
